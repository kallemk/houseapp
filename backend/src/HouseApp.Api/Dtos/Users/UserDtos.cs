...
public record UserDto(
    ...
    bool HasPassword,
    bool IsAdmin,
    /// <summary>Refused at sign-in and signed out immediately. This is what revocation means now.</summary>
    bool IsBlocked,
...
public record UpdateUserRequest(string DisplayName, bool IsAdmin, bool IsBlocked);
