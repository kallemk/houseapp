import { ActionIcon, Button, Center, Group, Loader, Stack, Table, TextInput, Title } from '@mantine/core'
  ...
  return (
    <Stack>
      ...
      {!valuations || valuations.length === 0 ? (
        <EmptyState message="No valuations logged yet." />
      ) : (
          ...
          <Table.Tbody>
            {valuations.map((v) => (
              <Table.Tr key={v.id}>
                ...
                <Table.Td>{v.value.toLocaleString()}</Table.Td>
